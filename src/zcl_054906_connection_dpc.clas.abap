class ZCL_054906_CONNECTION_DPC definition
  public
...
protected section.
  ...
  methods ZC_054906_CONNEC_CREATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_054906_CONNECTION_MPC=>TS_ZC_054906_CONNECTIONTPTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_054906_CONNEC_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_054906_CONNEC_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_054906_CONNEC_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_054906_CONNECTION_MPC=>TT_ZC_054906_CONNECTIONTPTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_054906_CONNEC_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
CLASS ZCL_054906_CONNECTION_DPC IMPLEMENTATION.
...
*&* This class has been generated on 22.03.2021 10:30:16 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_054906_CONNECTION_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA zc_054906_connec_create_entity TYPE zcl_054906_connection_mpc=>ts_zc_054906_connectiontptype.
...
*-------------------------------------------------------------------------*
*             EntitySet -  ZC_054906_ConnectionTP
*-------------------------------------------------------------------------*
     WHEN 'ZC_054906_ConnectionTP'.
*     Call the entity set generated method
    zc_054906_connec_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = zc_054906_connec_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = zc_054906_connec_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
      when 'ZC_054906_ConnectionTP'.
*     Call the entity set generated method
     zc_054906_connec_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zc_054906_connec_get_entity TYPE zcl_054906_connection_mpc=>ts_zc_054906_connectiontptype.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          zc_054906_connec_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zc_054906_connec_get_entity
                         es_response_context = es_response_context
          ).

        IF zc_054906_connec_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zc_054906_connec_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_054906_CONNECTION_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA zc_054906_connec_get_entityset TYPE zcl_054906_connection_mpc=>tt_zc_054906_connectiontptype.
 DATA lv_entityset_name TYPE string.
...
*-------------------------------------------------------------------------*
   WHEN 'ZC_054906_ConnectionTP'.
*     Call the entity set generated method
      zc_054906_connec_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = zc_054906_connec_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = zc_054906_connec_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zc_054906_connec_update_entity TYPE zcl_054906_connection_mpc=>ts_zc_054906_connectiontptype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*-------------------------------------------------------------------------*
      WHEN 'ZC_054906_ConnectionTP'.
*     Call the entity set generated method
          zc_054906_connec_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zc_054906_connec_update_entity
          ).
       IF zc_054906_connec_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zc_054906_connec_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_zc_054906_connectiontp_1 TYPE zc_054906_connectiontp ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="" >| &
               | <sadl:dataSource type="CDS" name="ZC_054906_CONNECTIONTP" binding="ZC_054906_CONNECTIONTP" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="ZC_054906_ConnectionTP" dataSource="ZC_054906_CONNECTIONTP" maxEditMode="RO" exposure="TRUE" >| &
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20210322103013
               iv_uuid              = 'Z054906CONNECTION'
               io_context           = me->mo_context ).
  endmethod.


  method ZC_054906_CONNEC_CREATE_ENTITY.
  ...
  method ZC_054906_CONNEC_UPDATE_ENTITY.
